...
import { askAssistant, isAiConfigured } from "./ai.js";
...
// support page (OpenRouter-backed AI chat UI — see ai.js)
app.get("/support", requireAuth, (req, res) => {
  res.render("support");
});

// AI support chat. Grounded in Iraqi logistics regulations via ai.js.
// Conversation memory lives on the session, capped to recent turns to bound cost.
const MAX_MESSAGE_CHARS = 2000;
const MAX_HISTORY_TURNS = 8; // user+model pairs kept for context
